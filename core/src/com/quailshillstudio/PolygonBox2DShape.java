...
public class PolygonBox2DShape extends Polygon{
	 ...
	 public PolygonBox2DShape(float[] verts) {
	    ...
	    public Array<PolygonBox2DShape> unionCS(Polygon poly) {
	        return this.clipCS(poly, false, false);
	    }

	    /** Calculate the intersection between two polygons */
	    public Array<PolygonBox2DShape> intersectionCS(Polygon poly) {
	        return this.clipCS(poly, true, true);
	    }

	    /** Calculate the difference between two polygons */
	    public Array<PolygonBox2DShape> differenceCS(Polygon poly) {
	        return this.clipCS(poly, false, true);
	    }
	    
	    
	    public Array<PolygonBox2DShape> clipCS(Polygon poly, boolean b, boolean b2){
	    	Array<Polygon> rs = super.clip(poly, b, b2);
			Array<PolygonBox2DShape> rsCS = new Array<PolygonBox2DShape>();
